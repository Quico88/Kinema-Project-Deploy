			...
			<Flex
				...
				justify="left">
					<Container maxW='900px' ms="none" ml="10vh" mt="10vh" >
						...
						<Text fontSize='2vh' textAlign="left" color="white"> {myMovie.description} </Text>
						<Box mt="3.5vh" mb="3vh">
							<Text justify="left" textAlign="left" fontWeight="bold" fontSize="2.5vh" color="#d90429">Genres</Text>
							<Text justify="left" textAlign="left" fontWeight="500" fontSize="2.3vh" color="white">{myMovie.genres?.map(el => el + (" "))}</Text>
						</Box>	
					...
					<Button borderRadius='3vh' bg="#354f52" color="white">MY LIST</Button>
				</Box>
				<Text textAlign="left" fontWeight="500" fontSize="2.3vh" color="#ffd000" mt="3.5vh">Rating: {Math.round(myMovie.rating * 100) / 100} || User reviews: {myMovie.user_reviews} </Text>
			</Container>
				</Flex> : <h1>Loading</h1>
			}	
			<Footer/>
